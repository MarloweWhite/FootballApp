...
public class AchievementInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView achievementInfo = v.findViewById(R.id.achievementInfo);
        ...
        SharedPreferences pref1 = getActivity().getSharedPreferences("ChampionPreference", 0);
        SharedPreferences pref2 = getActivity().getSharedPreferences("PremierPreference", 0);
        SharedPreferences pref3 = getActivity().getSharedPreferences("LeagueOnePreference", 0);
        SharedPreferences pref4 = getActivity().getSharedPreferences("LeagueTwoPreference", 0);
...
//                champion = champion + 1;
        ...
        if (achievementName.equals("Over 50%")) {
            ...
            overFifty.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Over 60%")) {
            ...
            overSixty.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Over 70%")) {
            ...
            overSeventy.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Over 80%")) {
            ...
            overEighty.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Over 90%")) {
            ...
            overNinety.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Done the lot!")) {
            ...
            doneTheLot.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("The Wanderer")) {
            ...
            theWanderer.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("The Wild Rover")) {
            ...
            theWildRover.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Cymru am byth")) {
            ...
            cymruAmByth.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Far and Wide")) {
            ...
            farAndWide.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Master and Apprentice")) {
            ...
            masterAndApprentice.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Oop North")) {
            ...
            oopNorth.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Perfect Premier")) {
            ...
            perfectPremier.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Championship Champ")) {
            ...
            championshipChamp.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("League 1 Done")) {
            ...
            leagueOneDone.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("League 2 Triumphed")) {
            ...
            leagueTwoTriumphed.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Little and large")) {
            ...
            littleAndLarge.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Cockney Conqueror")) {
            ...
            cockneyConqueror.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("All sit down")) {
            ...
            allSitDown.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Claret and Blue")) {
            ...
            claretAndBlue.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("City Slicker")) {
            ...
            citySlicker.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Park Ranger")) {
            ...
            parkRanger.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("The Champions")) {
            ...
            theChampions.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Le Champions")) {
            ...
            leChampions.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Respect your Elders")) {
            ...
            respectYourElders.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Neighbours")) {
            ...
            neighbours.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Longest and Shortest")) {
            ...
            longestAndshortest.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("What even is an Albion?!")) {
            ...
            whatIsAnAlbion.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("Im an athlete!")) {
            ...
            imAnAthlete.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
        ...
        if (achievementName.equals("The Compass")) {
            ...
            theCompass.createProgessBar(progressBar = v.findViewById(R.id.achievementProgressBar));
    ...
    public String getAchievementDetails(String field){
        ...
        try {
            ...
            JSONObject achievementInfo = root.getJSONObject(this.getActivity().getIntent().getStringExtra("AchievementLogic Name"));
