...
public class LeagueTwo extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ThemeSetting leagueTwoSetting = new ThemeSetting(pref1, this);
